...
describe('IncidentEntity', async () => {
  ...
  test('basic', async () => {
    ...
    assert(incident_ref01_resdata_up0[incident_ref01_markdef_up0.name] === incident_ref01_markdef_up0.value)
    ...
    // REMOVE
    const incident_ref01_match_rm0 = {}
    incident_ref01_match_rm0.id = incident_ref01_data.id
