# Statuspage SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions StatuspageSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both StatuspageSDK(...) and StatuspageSDK.test(...) become
#      StatuspageSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "statuspage_sdk"
_SDK_CLASS = "StatuspageSDK"
...
_ENTITIES = {
    "Component": "component",
    "ComponentGroupUptime": "component_group_uptime",
    ...
    "Page": "page",
    "PageAccessGroup": "page_access_group",
    "PageAccessUser": "page_access_user",
    "Permission": "permission",
    "Postmortem": "postmortem",
    "StatusEmbedConfig": "status_embed_config",
