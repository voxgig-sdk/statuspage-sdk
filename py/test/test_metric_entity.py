...
class TestMetricEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        metric_ref01_data = helpers.to_map(runner.entity_data(metric_ref01_ent.create(metric_ref01_data, None)))
        ...
        metric_ref01_resdata_up0 = helpers.to_map(runner.entity_data(metric_ref01_ent.update(metric_ref01_data_up0_up, None)))
        ...
        metric_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(metric_ref01_data_dt0_loaded))
