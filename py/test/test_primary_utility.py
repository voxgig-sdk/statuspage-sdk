...
from statuspage_sdk.core.response import StatuspageResponse
from statuspage_sdk.core.operation import StatuspageOperation
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return StatuspageError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = StatuspageSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = StatuspageSDK.test(None, None)
        ...
        class TestInitFeature(StatuspageBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(StatuspageBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = StatuspageSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = StatuspageSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = StatuspageSDK.test(None, setup_opts)
