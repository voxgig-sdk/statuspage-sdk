...
class TestPostmortemDirect:

    def test_should_direct_load_postmortem(self):
        setup = _postmortem_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-postmortem", "live" if setup["live"] else "unit")
        if _skip:
...
def _postmortem_direct_setup(mockres):
