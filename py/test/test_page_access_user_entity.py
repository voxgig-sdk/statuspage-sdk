...
class TestPageAccessUserEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        page_access_user_ref01_data = helpers.to_map(runner.entity_data(page_access_user_ref01_ent.create(page_access_user_ref01_data, None)))
        ...
        page_access_user_ref01_resdata_up0 = helpers.to_map(runner.entity_data(page_access_user_ref01_ent.update(page_access_user_ref01_data_up0_up, None)))
        ...
        page_access_user_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(page_access_user_ref01_data_dt0_loaded))
