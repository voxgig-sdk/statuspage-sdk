...
class TestIncidentEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        incident_ref01_data = helpers.to_map(runner.entity_data(incident_ref01_ent.create(incident_ref01_data, None)))
        ...
        incident_ref01_resdata_up0 = helpers.to_map(runner.entity_data(incident_ref01_ent.update(incident_ref01_data_up0_up, None)))
        ...
        incident_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(incident_ref01_data_dt0_loaded))
