...
class IncidentSubscriberEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IncidentSubscriberEntity(self._client, opts)
    ...
    def data_get(self) -> IncidentSubscriber:
    ...
    def match_get(self) -> IncidentSubscriber:
    ...
    def create(self, reqdata: IncidentSubscriberCreateData, ctrl=None) -> IncidentSubscriber:
        utility = self._utility
