...
class IncidentTemplateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IncidentTemplateEntity(self._client, opts)
    ...
    def data_get(self) -> IncidentTemplate:
    ...
    def match_get(self) -> IncidentTemplate:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[IncidentTemplate]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.IncidentTemplate().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: IncidentTemplateCreateData, ctrl=None) -> IncidentTemplate:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
