...
class ComponentGroupUptimeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ComponentGroupUptimeEntity(self._client, opts)
    ...
    def data_get(self) -> ComponentGroupUptime:
    ...
    def match_get(self) -> ComponentGroupUptime:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ComponentGroupUptime:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ComponentGroupUptime().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
