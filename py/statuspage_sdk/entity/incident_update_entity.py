...
class IncidentUpdateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IncidentUpdateEntity(self._client, opts)
    ...
    def data_get(self) -> IncidentUpdate:
    ...
    def match_get(self) -> IncidentUpdate:
    ...
    def update(self, reqdata: IncidentUpdateUpdateData, ctrl=None) -> IncidentUpdate:
        utility = self._utility
