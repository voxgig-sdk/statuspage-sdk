...
|---|---|---|
| `ts/` | @voxgig-sdk/statuspage | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/statuspage \
      --repository voxgig-sdk/statuspage-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/statuspage` shows it, and
`npm trust revoke @voxgig-sdk/statuspage --id=<id>` removes it.
