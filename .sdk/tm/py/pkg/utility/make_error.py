...
from projectname_sdk.core.control import StatuspageControl
from projectname_sdk.core.error import StatuspageError


def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import StatuspageContext
        ctx = StatuspageContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, StatuspageError):
        errmsg = err.msg
    ...
    sdk_err = StatuspageError("", msg, ctx)
