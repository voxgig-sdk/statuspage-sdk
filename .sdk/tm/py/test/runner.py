...
class StatuspageTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StatuspageTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = StatuspageTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = StatuspageTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
