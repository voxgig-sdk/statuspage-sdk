...
class StatuspageTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StatuspageTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = StatuspageTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = StatuspageTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
