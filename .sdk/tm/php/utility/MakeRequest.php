...
// Statuspage SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class StatuspageMakeRequest
{
    public static function call(StatuspageContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new StatuspageResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new StatuspageResponse($fetched);
        } else {
