...
class StatuspageCacheFeature extends StatuspageBaseFeature
{
    ...
    private function _through(StatuspageContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
