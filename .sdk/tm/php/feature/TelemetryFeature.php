...
// Statuspage SDK telemetry feature
...
class StatuspageTelemetryFeature extends StatuspageBaseFeature
{
    ...
    private function _close(StatuspageContext $ctx, bool $ok): void
    {
