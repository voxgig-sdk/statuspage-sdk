...
// Statuspage SDK idempotency feature
...
class StatuspageIdempotencyFeature extends StatuspageBaseFeature
{
    ...
    private function _mutating(StatuspageContext $ctx): bool
    {
