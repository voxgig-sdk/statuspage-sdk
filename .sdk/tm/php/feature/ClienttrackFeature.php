...
// Statuspage SDK clienttrack feature
...
class StatuspageClienttrackFeature extends StatuspageBaseFeature
{
    ...
    public function PostConstruct(StatuspageContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Statuspage-SDK';
