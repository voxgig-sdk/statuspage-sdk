...
class StatuspageProxyFeature extends StatuspageBaseFeature
{
    ...
    public function init(StatuspageContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (StatuspageContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
