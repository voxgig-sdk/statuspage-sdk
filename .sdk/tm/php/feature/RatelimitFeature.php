...
// Statuspage SDK ratelimit feature
...
class StatuspageRatelimitFeature extends StatuspageBaseFeature
{
    ...
    private function _acquire(StatuspageContext $ctx): void
    {
    ...
    private function _track(StatuspageContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
