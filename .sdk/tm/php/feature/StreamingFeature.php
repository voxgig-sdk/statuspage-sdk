...
// Statuspage SDK streaming feature
...
class StatuspageStreamingFeature extends StatuspageBaseFeature
{
    ...
    private function _iterate(StatuspageResult $result): \Generator
    {
    ...
    private function _streamable(StatuspageContext $ctx): bool
    {
