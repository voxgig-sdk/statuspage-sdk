...
class StatuspageRbacFeature extends StatuspageBaseFeature
{
    ...
    private function _required(StatuspageContext $ctx): ?string
    {
    ...
    private function _reject(StatuspageContext $ctx, string $required): void
    {
    ...
    private function _track(StatuspageContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
