...
describe("ComponentGroupUptimeDirect", function()
  it("should direct-load-component_group_uptime", function()
    local setup = component_group_uptime_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-component_group_uptime", setup.live and "live" or "unit")
...
function component_group_uptime_direct_setup(mockres)
