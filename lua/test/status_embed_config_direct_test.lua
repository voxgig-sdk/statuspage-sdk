...
describe("StatusEmbedConfigDirect", function()
  it("should direct-load-status_embed_config", function()
    local setup = status_embed_config_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-status_embed_config", setup.live and "live" or "unit")
...
function status_embed_config_direct_setup(mockres)
