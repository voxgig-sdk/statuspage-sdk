...
describe("IncidentTemplateDirect", function()
  it("should direct-list-incident_template", function()
    local setup = incident_template_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-incident_template", setup.live and "live" or "unit")
...
function incident_template_direct_setup(mockres)
