...
describe("PostmortemDirect", function()
  it("should direct-load-postmortem", function()
    local setup = postmortem_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-postmortem", setup.live and "live" or "unit")
...
function postmortem_direct_setup(mockres)
