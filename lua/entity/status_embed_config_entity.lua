...
local StatusEmbedConfigEntity = {}
StatusEmbedConfigEntity.__index = StatusEmbedConfigEntity


function StatusEmbedConfigEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, StatusEmbedConfigEntity)
  self._name = "status_embed_config"
  self._client = client
...
function StatusEmbedConfigEntity:get_name()
  return self._name
end


function StatusEmbedConfigEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return StatusEmbedConfigEntity.new(self._client, opts)
end
...
function StatusEmbedConfigEntity:mark_deleted()
  self._deleted = true
end


function StatusEmbedConfigEntity:deleted()
  return true == self._deleted
end


function StatusEmbedConfigEntity:data_set(args)
  if args ~= nil then
...
function StatusEmbedConfigEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function StatusEmbedConfigEntity:match_set(args)
  if args ~= nil then
...
function StatusEmbedConfigEntity:match_get()
...
function StatusEmbedConfigEntity:stream(action, args, callopts)
...
---@param reqmatch StatusEmbedConfigLoadMatch
---@param ctrl? table
---@return StatusEmbedConfig
---@return string? err
function StatusEmbedConfigEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata StatusEmbedConfigUpdateData
---@param ctrl? table
---@return StatusEmbedConfig
---@return string? err
function StatusEmbedConfigEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function StatusEmbedConfigEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return StatusEmbedConfigEntity
