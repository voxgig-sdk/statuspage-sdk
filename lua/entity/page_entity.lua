...
---@param reqmatch PageLoadMatch
---@param ctrl? table
---@return Page
---@return string? err
function PageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PageListMatch
---@param ctrl? table
---@return Page[]
---@return string? err
function PageEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PageUpdateData
---@param ctrl? table
---@return Page
---@return string? err
function PageEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
