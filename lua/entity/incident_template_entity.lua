...
local IncidentTemplateEntity = {}
IncidentTemplateEntity.__index = IncidentTemplateEntity


function IncidentTemplateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IncidentTemplateEntity)
  self._name = "incident_template"
  self._client = client
...
function IncidentTemplateEntity:get_name()
  return self._name
end


function IncidentTemplateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IncidentTemplateEntity.new(self._client, opts)
end
...
function IncidentTemplateEntity:mark_deleted()
  self._deleted = true
end


function IncidentTemplateEntity:deleted()
  return true == self._deleted
end


function IncidentTemplateEntity:data_set(args)
  if args ~= nil then
...
function IncidentTemplateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IncidentTemplateEntity:match_set(args)
  if args ~= nil then
...
function IncidentTemplateEntity:match_get()
...
function IncidentTemplateEntity:stream(action, args, callopts)
...
---@param reqmatch IncidentTemplateListMatch
---@param ctrl? table
---@return IncidentTemplate[]
---@return string? err
function IncidentTemplateEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata IncidentTemplateCreateData
---@param ctrl? table
---@return IncidentTemplate
---@return string? err
function IncidentTemplateEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function IncidentTemplateEntity:_run_op(ctx, post_done)
  local utility = self._utility
