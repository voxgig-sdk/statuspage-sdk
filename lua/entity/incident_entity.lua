...
local IncidentEntity = {}
IncidentEntity.__index = IncidentEntity


function IncidentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IncidentEntity)
  self._name = "incident"
  self._client = client
...
function IncidentEntity:get_name()
  return self._name
end


function IncidentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IncidentEntity.new(self._client, opts)
end
...
function IncidentEntity:mark_deleted()
  self._deleted = true
end


function IncidentEntity:deleted()
  return true == self._deleted
end


function IncidentEntity:data_set(args)
  if args ~= nil then
...
function IncidentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IncidentEntity:match_set(args)
  if args ~= nil then
...
function IncidentEntity:match_get()
...
function IncidentEntity:stream(action, args, callopts)
...
---@param reqmatch IncidentLoadMatch
---@param ctrl? table
---@return Incident
---@return string? err
function IncidentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch IncidentListMatch
---@param ctrl? table
---@return Incident[]
---@return string? err
function IncidentEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata IncidentCreateData
---@param ctrl? table
---@return Incident
---@return string? err
function IncidentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata IncidentUpdateData
---@param ctrl? table
---@return Incident
---@return string? err
function IncidentEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch IncidentRemoveMatch
---@param ctrl? table
---@return Incident
---@return string? err
function IncidentEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function IncidentEntity:_run_op(ctx, post_done)
  local utility = self._utility
