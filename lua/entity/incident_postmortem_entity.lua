...
local IncidentPostmortemEntity = {}
IncidentPostmortemEntity.__index = IncidentPostmortemEntity


function IncidentPostmortemEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IncidentPostmortemEntity)
  self._name = "incident_postmortem"
  self._client = client
...
function IncidentPostmortemEntity:get_name()
  return self._name
end


function IncidentPostmortemEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IncidentPostmortemEntity.new(self._client, opts)
end
...
function IncidentPostmortemEntity:mark_deleted()
  self._deleted = true
end


function IncidentPostmortemEntity:deleted()
  return true == self._deleted
end


function IncidentPostmortemEntity:data_set(args)
  if args ~= nil then
...
function IncidentPostmortemEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IncidentPostmortemEntity:match_set(args)
  if args ~= nil then
...
function IncidentPostmortemEntity:match_get()
...
function IncidentPostmortemEntity:stream(action, args, callopts)
...
---@param reqmatch IncidentPostmortemRemoveMatch
---@param ctrl? table
---@return IncidentPostmortem
---@return string? err
function IncidentPostmortemEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function IncidentPostmortemEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return IncidentPostmortemEntity
