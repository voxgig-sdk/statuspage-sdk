...
local PostmortemEntity = {}
PostmortemEntity.__index = PostmortemEntity


function PostmortemEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PostmortemEntity)
  self._name = "postmortem"
  self._client = client
...
function PostmortemEntity:get_name()
  return self._name
end


function PostmortemEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PostmortemEntity.new(self._client, opts)
end
...
function PostmortemEntity:mark_deleted()
  self._deleted = true
end


function PostmortemEntity:deleted()
  return true == self._deleted
end


function PostmortemEntity:data_set(args)
  if args ~= nil then
...
function PostmortemEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PostmortemEntity:match_set(args)
  if args ~= nil then
...
function PostmortemEntity:match_get()
...
function PostmortemEntity:stream(action, args, callopts)
...
---@param reqmatch PostmortemLoadMatch
---@param ctrl? table
---@return Postmortem
---@return string? err
function PostmortemEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata PostmortemUpdateData
---@param ctrl? table
---@return Postmortem
---@return string? err
function PostmortemEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function PostmortemEntity:_run_op(ctx, post_done)
  local utility = self._utility
