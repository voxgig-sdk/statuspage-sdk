...
local GroupComponentEntity = {}
GroupComponentEntity.__index = GroupComponentEntity


function GroupComponentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GroupComponentEntity)
  self._name = "group_component"
  self._client = client
...
function GroupComponentEntity:get_name()
  return self._name
end


function GroupComponentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GroupComponentEntity.new(self._client, opts)
end
...
function GroupComponentEntity:mark_deleted()
  self._deleted = true
end


function GroupComponentEntity:deleted()
  return true == self._deleted
end


function GroupComponentEntity:data_set(args)
  if args ~= nil then
...
function GroupComponentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GroupComponentEntity:match_set(args)
  if args ~= nil then
...
function GroupComponentEntity:match_get()
...
function GroupComponentEntity:stream(action, args, callopts)
...
---@param reqmatch GroupComponentLoadMatch
---@param ctrl? table
---@return GroupComponent
---@return string? err
function GroupComponentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch GroupComponentListMatch
---@param ctrl? table
---@return GroupComponent[]
---@return string? err
function GroupComponentEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata GroupComponentCreateData
---@param ctrl? table
---@return GroupComponent
---@return string? err
function GroupComponentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata GroupComponentUpdateData
---@param ctrl? table
---@return GroupComponent
---@return string? err
function GroupComponentEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch GroupComponentRemoveMatch
---@param ctrl? table
---@return GroupComponent
---@return string? err
function GroupComponentEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function GroupComponentEntity:_run_op(ctx, post_done)
  local utility = self._utility
