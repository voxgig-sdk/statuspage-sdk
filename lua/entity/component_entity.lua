...
local ComponentEntity = {}
ComponentEntity.__index = ComponentEntity


function ComponentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ComponentEntity)
...
function ComponentEntity:get_name()
  return self._name
end


function ComponentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ComponentEntity.new(self._client, opts)
end
...
function ComponentEntity:mark_deleted()
  self._deleted = true
end


function ComponentEntity:deleted()
  return true == self._deleted
end


function ComponentEntity:data_set(args)
  if args ~= nil then
...
function ComponentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ComponentEntity:match_set(args)
  if args ~= nil then
...
function ComponentEntity:match_get()
...
function ComponentEntity:stream(action, args, callopts)
...
---@param reqmatch ComponentLoadMatch
---@param ctrl? table
---@return Component
---@return string? err
function ComponentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ComponentListMatch
---@param ctrl? table
---@return Component[]
---@return string? err
function ComponentEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ComponentCreateData
---@param ctrl? table
---@return Component
---@return string? err
function ComponentEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ComponentUpdateData
---@param ctrl? table
---@return Component
---@return string? err
function ComponentEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ComponentRemoveMatch
---@param ctrl? table
---@return Component
---@return string? err
function ComponentEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ComponentEntity:_run_op(ctx, post_done)
  local utility = self._utility
