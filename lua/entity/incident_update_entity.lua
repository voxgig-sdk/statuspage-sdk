...
local IncidentUpdateEntity = {}
IncidentUpdateEntity.__index = IncidentUpdateEntity


function IncidentUpdateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IncidentUpdateEntity)
  self._name = "incident_update"
  self._client = client
...
function IncidentUpdateEntity:get_name()
  return self._name
end


function IncidentUpdateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IncidentUpdateEntity.new(self._client, opts)
end
...
function IncidentUpdateEntity:mark_deleted()
  self._deleted = true
end


function IncidentUpdateEntity:deleted()
  return true == self._deleted
end


function IncidentUpdateEntity:data_set(args)
  if args ~= nil then
...
function IncidentUpdateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IncidentUpdateEntity:match_set(args)
  if args ~= nil then
...
function IncidentUpdateEntity:match_get()
...
function IncidentUpdateEntity:stream(action, args, callopts)
...
---@param reqdata IncidentUpdateUpdateData
---@param ctrl? table
---@return IncidentUpdate
---@return string? err
function IncidentUpdateEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function IncidentUpdateEntity:_run_op(ctx, post_done)
  local utility = self._utility
