...
local IncidentSubscriberEntity = {}
IncidentSubscriberEntity.__index = IncidentSubscriberEntity


function IncidentSubscriberEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IncidentSubscriberEntity)
  self._name = "incident_subscriber"
  self._client = client
...
function IncidentSubscriberEntity:get_name()
  return self._name
end


function IncidentSubscriberEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IncidentSubscriberEntity.new(self._client, opts)
end
...
function IncidentSubscriberEntity:mark_deleted()
  self._deleted = true
end


function IncidentSubscriberEntity:deleted()
  return true == self._deleted
end


function IncidentSubscriberEntity:data_set(args)
  if args ~= nil then
...
function IncidentSubscriberEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IncidentSubscriberEntity:match_set(args)
  if args ~= nil then
...
function IncidentSubscriberEntity:match_get()
...
function IncidentSubscriberEntity:stream(action, args, callopts)
...
---@param reqdata IncidentSubscriberCreateData
---@param ctrl? table
---@return IncidentSubscriber
---@return string? err
function IncidentSubscriberEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function IncidentSubscriberEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return IncidentSubscriberEntity
