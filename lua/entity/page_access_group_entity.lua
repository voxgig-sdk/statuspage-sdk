...
local PageAccessGroupEntity = {}
PageAccessGroupEntity.__index = PageAccessGroupEntity


function PageAccessGroupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PageAccessGroupEntity)
  self._name = "page_access_group"
  self._client = client
...
function PageAccessGroupEntity:get_name()
  return self._name
end


function PageAccessGroupEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PageAccessGroupEntity.new(self._client, opts)
end
...
function PageAccessGroupEntity:mark_deleted()
  self._deleted = true
end


function PageAccessGroupEntity:deleted()
  return true == self._deleted
end


function PageAccessGroupEntity:data_set(args)
  if args ~= nil then
...
function PageAccessGroupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PageAccessGroupEntity:match_set(args)
  if args ~= nil then
...
function PageAccessGroupEntity:match_get()
...
function PageAccessGroupEntity:stream(action, args, callopts)
...
---@param reqmatch PageAccessGroupLoadMatch
---@param ctrl? table
---@return PageAccessGroup
---@return string? err
function PageAccessGroupEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PageAccessGroupListMatch
---@param ctrl? table
---@return PageAccessGroup[]
---@return string? err
function PageAccessGroupEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PageAccessGroupCreateData
---@param ctrl? table
---@return PageAccessGroup
---@return string? err
function PageAccessGroupEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata PageAccessGroupUpdateData
---@param ctrl? table
---@return PageAccessGroup
---@return string? err
function PageAccessGroupEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch PageAccessGroupRemoveMatch
---@param ctrl? table
---@return PageAccessGroup
---@return string? err
function PageAccessGroupEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function PageAccessGroupEntity:_run_op(ctx, post_done)
  local utility = self._utility
