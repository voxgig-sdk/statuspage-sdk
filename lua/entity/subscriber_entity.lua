...
local SubscriberEntity = {}
SubscriberEntity.__index = SubscriberEntity


function SubscriberEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriberEntity)
...
function SubscriberEntity:get_name()
  return self._name
end


function SubscriberEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriberEntity.new(self._client, opts)
end
...
function SubscriberEntity:mark_deleted()
  self._deleted = true
end


function SubscriberEntity:deleted()
  return true == self._deleted
end


function SubscriberEntity:data_set(args)
  if args ~= nil then
...
function SubscriberEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriberEntity:match_set(args)
  if args ~= nil then
...
function SubscriberEntity:match_get()
...
function SubscriberEntity:stream(action, args, callopts)
...
---@param reqmatch SubscriberLoadMatch
---@param ctrl? table
---@return Subscriber
---@return string? err
function SubscriberEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch SubscriberListMatch
---@param ctrl? table
---@return Subscriber[]
---@return string? err
function SubscriberEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata SubscriberCreateData
---@param ctrl? table
---@return Subscriber
---@return string? err
function SubscriberEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata SubscriberUpdateData
---@param ctrl? table
---@return Subscriber
---@return string? err
function SubscriberEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch SubscriberRemoveMatch
---@param ctrl? table
---@return Subscriber
---@return string? err
function SubscriberEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function SubscriberEntity:_run_op(ctx, post_done)
  local utility = self._utility
