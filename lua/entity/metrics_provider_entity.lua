...
local MetricsProviderEntity = {}
MetricsProviderEntity.__index = MetricsProviderEntity


function MetricsProviderEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MetricsProviderEntity)
  self._name = "metrics_provider"
  self._client = client
...
function MetricsProviderEntity:get_name()
  return self._name
end


function MetricsProviderEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MetricsProviderEntity.new(self._client, opts)
end
...
function MetricsProviderEntity:mark_deleted()
  self._deleted = true
end


function MetricsProviderEntity:deleted()
  return true == self._deleted
end


function MetricsProviderEntity:data_set(args)
  if args ~= nil then
...
function MetricsProviderEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MetricsProviderEntity:match_set(args)
  if args ~= nil then
...
function MetricsProviderEntity:match_get()
...
function MetricsProviderEntity:stream(action, args, callopts)
...
---@param reqmatch MetricsProviderLoadMatch
---@param ctrl? table
---@return MetricsProvider
---@return string? err
function MetricsProviderEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch MetricsProviderListMatch
---@param ctrl? table
---@return MetricsProvider[]
---@return string? err
function MetricsProviderEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata MetricsProviderCreateData
---@param ctrl? table
---@return MetricsProvider
---@return string? err
function MetricsProviderEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata MetricsProviderUpdateData
---@param ctrl? table
---@return MetricsProvider
---@return string? err
function MetricsProviderEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch MetricsProviderRemoveMatch
---@param ctrl? table
---@return MetricsProvider
---@return string? err
function MetricsProviderEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function MetricsProviderEntity:_run_op(ctx, post_done)
  local utility = self._utility
