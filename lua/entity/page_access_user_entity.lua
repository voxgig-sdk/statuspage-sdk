...
local PageAccessUserEntity = {}
PageAccessUserEntity.__index = PageAccessUserEntity


function PageAccessUserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PageAccessUserEntity)
  self._name = "page_access_user"
  self._client = client
...
function PageAccessUserEntity:get_name()
  return self._name
end


function PageAccessUserEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PageAccessUserEntity.new(self._client, opts)
end
...
function PageAccessUserEntity:mark_deleted()
  self._deleted = true
end


function PageAccessUserEntity:deleted()
  return true == self._deleted
end


function PageAccessUserEntity:data_set(args)
  if args ~= nil then
...
function PageAccessUserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PageAccessUserEntity:match_set(args)
  if args ~= nil then
...
function PageAccessUserEntity:match_get()
...
function PageAccessUserEntity:stream(action, args, callopts)
...
---@param reqmatch PageAccessUserLoadMatch
---@param ctrl? table
---@return PageAccessUser
---@return string? err
function PageAccessUserEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PageAccessUserListMatch
---@param ctrl? table
---@return PageAccessUser[]
---@return string? err
function PageAccessUserEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PageAccessUserCreateData
---@param ctrl? table
---@return PageAccessUser
---@return string? err
function PageAccessUserEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata PageAccessUserUpdateData
---@param ctrl? table
---@return PageAccessUser
---@return string? err
function PageAccessUserEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch PageAccessUserRemoveMatch
---@param ctrl? table
---@return PageAccessUser
---@return string? err
function PageAccessUserEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function PageAccessUserEntity:_run_op(ctx, post_done)
  local utility = self._utility
