...
module StatuspageTestRunner
  ...
  def self.env_override(m)
    live = getenv("STATUSPAGE_TEST_LIVE")
    override = getenv("STATUSPAGE_TEST_OVERRIDE")
    ...
    explain = getenv("STATUSPAGE_TEST_EXPLAIN")
    m["STATUSPAGE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = StatuspageTestRunner
Helpers = StatuspageHelpers
Vs = VoxgigStruct
