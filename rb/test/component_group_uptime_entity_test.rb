...
class ComponentGroupUptimeEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    component_group_uptime_ref01_data_dt0_load_result = Helpers.to_map(component_group_uptime_ref01_data_dt0_loaded.respond_to?(:data_get) ? component_group_uptime_ref01_data_dt0_loaded.data_get : component_group_uptime_ref01_data_dt0_loaded)
