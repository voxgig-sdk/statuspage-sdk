...
class PermissionEntity
  ...
  #
  # @param reqmatch [PermissionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Permission.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Permission, Hash] the loaded Permission; raises StatuspageError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Permission, Hash] the updated Permission; raises StatuspageError on failure
