...
class PageEntity
  ...
  # @return [Page, Hash] the current Page data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Page fields)
  def match_get
  ...
  # Load a single Page.
  #
  # @param reqmatch [PageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Page.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Page, Hash] the loaded Page; raises StatuspageError on failure
  ...
  #
  # @param reqmatch [PageListMatch, Hash, nil] match filter (any subset of
  #   Page fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Page>, Array] the matching Page items; raises StatuspageError on failure
  ...
  #
  # @param reqdata [PageUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Page, Hash] the updated Page; raises StatuspageError on failure
