...
class ComponentGroupUptimeEntity
  ...
  def make
    opts = @_entopts.dup
    ComponentGroupUptimeEntity.new(@_client, opts)
  end
  ...
  # @return [ComponentGroupUptime, Hash] the current ComponentGroupUptime data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ComponentGroupUptime fields)
  def match_get
  ...
  #
  # @param reqmatch [ComponentGroupUptimeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ComponentGroupUptime.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ComponentGroupUptime, Hash] the loaded ComponentGroupUptime; raises StatuspageError on failure
