...
class ComponentEntity
  ...
  def make
    opts = @_entopts.dup
    ComponentEntity.new(@_client, opts)
  end
  ...
  # @return [Component, Hash] the current Component data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Component fields)
  def match_get
  ...
  #
  # @param reqmatch [ComponentLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Component.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Component, Hash] the loaded Component; raises StatuspageError on failure
  ...
  #
  # @param reqmatch [ComponentListMatch, Hash, nil] match filter (any subset of
  #   Component fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Component>, Array] the matching Component items; raises StatuspageError on failure
  ...
  #
  # @param reqdata [ComponentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Component, Hash] the created Component; raises StatuspageError on failure
  ...
  #
  # @param reqdata [ComponentUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Component, Hash] the updated Component; raises StatuspageError on failure
  ...
  #
  # @param reqmatch [ComponentRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Component, Hash] the removed Component; raises StatuspageError on failure
