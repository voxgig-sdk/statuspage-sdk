...
class IncidentEntity
  ...
  def make
    opts = @_entopts.dup
    IncidentEntity.new(@_client, opts)
  end
  ...
  # @return [Incident, Hash] the current Incident data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Incident fields)
  def match_get
  ...
  #
  # @param reqmatch [IncidentLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Incident.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Incident, Hash] the loaded Incident; raises StatuspageError on failure
  ...
  #
  # @param reqmatch [IncidentListMatch, Hash, nil] match filter (any subset of
  #   Incident fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Incident>, Array] the matching Incident items; raises StatuspageError on failure
  ...
  #
  # @param reqdata [IncidentCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Incident, Hash] the created Incident; raises StatuspageError on failure
  ...
  #
  # @param reqdata [IncidentUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Incident, Hash] the updated Incident; raises StatuspageError on failure
  ...
  #
  # @param reqmatch [IncidentRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Incident, Hash] the removed Incident; raises StatuspageError on failure
