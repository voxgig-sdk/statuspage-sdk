...
class IncidentSubscriberEntity
  ...
  def make
    opts = @_entopts.dup
    IncidentSubscriberEntity.new(@_client, opts)
  end
  ...
  # @return [IncidentSubscriber, Hash] the current IncidentSubscriber data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of IncidentSubscriber fields)
  def match_get
  ...
  #
  # @param reqdata [IncidentSubscriberCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [IncidentSubscriber, Hash] the created IncidentSubscriber; raises StatuspageError on failure
