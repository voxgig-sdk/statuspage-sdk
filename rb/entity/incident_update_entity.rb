...
class IncidentUpdateEntity
  ...
  def make
    opts = @_entopts.dup
    IncidentUpdateEntity.new(@_client, opts)
  end
  ...
  # @return [IncidentUpdate, Hash] the current IncidentUpdate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of IncidentUpdate fields)
  def match_get
  ...
  #
  # @param reqdata [IncidentUpdateUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [IncidentUpdate, Hash] the updated IncidentUpdate; raises StatuspageError on failure
