...
class PostmortemEntity
  ...
  def make
    opts = @_entopts.dup
    PostmortemEntity.new(@_client, opts)
  end
  ...
  # @return [Postmortem, Hash] the current Postmortem data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Postmortem fields)
  def match_get
  ...
  #
  # @param reqmatch [PostmortemLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Postmortem.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Postmortem, Hash] the loaded Postmortem; raises StatuspageError on failure
  ...
  #
  # @param reqdata [PostmortemUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Postmortem, Hash] the updated Postmortem; raises StatuspageError on failure
