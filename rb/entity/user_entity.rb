...
class UserEntity
  ...
  # @return [Array<User>, Array] the matching User items; raises StatuspageError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [User, Hash] the created User; raises StatuspageError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [User, Hash] the removed User; raises StatuspageError on failure
