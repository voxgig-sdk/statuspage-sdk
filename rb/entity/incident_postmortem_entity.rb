...
class IncidentPostmortemEntity
  ...
  def make
    opts = @_entopts.dup
    IncidentPostmortemEntity.new(@_client, opts)
  end
  ...
  # @return [IncidentPostmortem, Hash] the current IncidentPostmortem data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of IncidentPostmortem fields)
  def match_get
  ...
  #
  # @param reqmatch [IncidentPostmortemRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [IncidentPostmortem, Hash] the removed IncidentPostmortem; raises StatuspageError on failure
