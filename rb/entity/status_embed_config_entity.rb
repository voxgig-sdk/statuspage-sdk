...
class StatusEmbedConfigEntity
  ...
  def make
    opts = @_entopts.dup
    StatusEmbedConfigEntity.new(@_client, opts)
  end
  ...
  # @return [StatusEmbedConfig, Hash] the current StatusEmbedConfig data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StatusEmbedConfig fields)
  def match_get
  ...
  #
  # @param reqmatch [StatusEmbedConfigLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.StatusEmbedConfig.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [StatusEmbedConfig, Hash] the loaded StatusEmbedConfig; raises StatuspageError on failure
  ...
  #
  # @param reqdata [StatusEmbedConfigUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [StatusEmbedConfig, Hash] the updated StatusEmbedConfig; raises StatuspageError on failure
