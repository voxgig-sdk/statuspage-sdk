...
class SubscriberEntity
  ...
  def make
    opts = @_entopts.dup
    SubscriberEntity.new(@_client, opts)
  end
  ...
  # @return [Subscriber, Hash] the current Subscriber data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Subscriber fields)
  def match_get
  ...
  #
  # @param reqmatch [SubscriberLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Subscriber.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Subscriber, Hash] the loaded Subscriber; raises StatuspageError on failure
  ...
  #
  # @param reqmatch [SubscriberListMatch, Hash, nil] match filter (any subset of
  #   Subscriber fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Subscriber>, Array] the matching Subscriber items; raises StatuspageError on failure
  ...
  #
  # @param reqdata [SubscriberCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Subscriber, Hash] the created Subscriber; raises StatuspageError on failure
  ...
  #
  # @param reqdata [SubscriberUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Subscriber, Hash] the updated Subscriber; raises StatuspageError on failure
  ...
  #
  # @param reqmatch [SubscriberRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Subscriber, Hash] the removed Subscriber; raises StatuspageError on failure
