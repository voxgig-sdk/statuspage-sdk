...
class PageAccessUserEntity
  ...
  def make
    opts = @_entopts.dup
    PageAccessUserEntity.new(@_client, opts)
  end
  ...
  # @return [PageAccessUser, Hash] the current PageAccessUser data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PageAccessUser fields)
  def match_get
  ...
  #
  # @param reqmatch [PageAccessUserLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.PageAccessUser.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [PageAccessUser, Hash] the loaded PageAccessUser; raises StatuspageError on failure
  ...
  #
  # @param reqmatch [PageAccessUserListMatch, Hash, nil] match filter (any subset of
  #   PageAccessUser fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PageAccessUser>, Array] the matching PageAccessUser items; raises StatuspageError on failure
  ...
  #
  # @param reqdata [PageAccessUserCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PageAccessUser, Hash] the created PageAccessUser; raises StatuspageError on failure
  ...
  #
  # @param reqdata [PageAccessUserUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [PageAccessUser, Hash] the updated PageAccessUser; raises StatuspageError on failure
  ...
  #
  # @param reqmatch [PageAccessUserRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [PageAccessUser, Hash] the removed PageAccessUser; raises StatuspageError on failure
