...
const testSeed = `map[string]any{"entity": map[string]any{"component": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "component_group_uptime": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group_component": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "incident": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "incident_postmortem": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "incident_subscriber": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "incident_template": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "incident_update": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "metric": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "metrics_provider": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "page_access_group": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "page_access_user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "permission": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "postmortem": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "status_embed_config": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscriber": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
