...
type IncidentSubscriberEntity struct {
	name    string
...
func NewIncidentSubscriberEntity(client *core.StatuspageSDK, entopts map[string]any) *IncidentSubscriberEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IncidentSubscriberEntity) GetName() string { return e.name }
...
func (e *IncidentSubscriberEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IncidentSubscriberEntity) Deleted() bool {
	return e.deleted
}


func (e *IncidentSubscriberEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIncidentSubscriberEntity(e.client, opts)
}

func (e *IncidentSubscriberEntity) Data(args ...any) any {
...
func (e *IncidentSubscriberEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IncidentSubscriber; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IncidentSubscriberEntity) DataTyped(data ...IncidentSubscriber) IncidentSubscriber {
	if len(data) > 0 {
		return typedFrom[IncidentSubscriber](e.Data(asMap(data[0])))
	}
	return typedFrom[IncidentSubscriber](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IncidentSubscriber (all fields
// optional at the wire level).
func (e *IncidentSubscriberEntity) MatchTyped(match ...IncidentSubscriber) IncidentSubscriber {
	if len(match) > 0 {
		return typedFrom[IncidentSubscriber](e.Match(asMap(match[0])))
	}
	return typedFrom[IncidentSubscriber](e.Match())
}
...
func (e *IncidentSubscriberEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IncidentSubscriberEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IncidentSubscriberEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *IncidentSubscriberEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IncidentSubscriberCreateData and returns an IncidentSubscriber. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *IncidentSubscriberEntity) CreateTyped(reqdata IncidentSubscriberCreateData, ctrl map[string]any) (IncidentSubscriber, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return IncidentSubscriber{}, err
	}
	return typedFrom[IncidentSubscriber](res), nil
}



func (e *IncidentSubscriberEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IncidentSubscriberEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IncidentSubscriberEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
