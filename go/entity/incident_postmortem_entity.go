...
type IncidentPostmortemEntity struct {
	name    string
...
func NewIncidentPostmortemEntity(client *core.StatuspageSDK, entopts map[string]any) *IncidentPostmortemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IncidentPostmortemEntity) GetName() string { return e.name }
...
func (e *IncidentPostmortemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IncidentPostmortemEntity) Deleted() bool {
	return e.deleted
}


func (e *IncidentPostmortemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIncidentPostmortemEntity(e.client, opts)
}

func (e *IncidentPostmortemEntity) Data(args ...any) any {
...
func (e *IncidentPostmortemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IncidentPostmortem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IncidentPostmortemEntity) DataTyped(data ...IncidentPostmortem) IncidentPostmortem {
	if len(data) > 0 {
		return typedFrom[IncidentPostmortem](e.Data(asMap(data[0])))
	}
	return typedFrom[IncidentPostmortem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IncidentPostmortem (all fields
// optional at the wire level).
func (e *IncidentPostmortemEntity) MatchTyped(match ...IncidentPostmortem) IncidentPostmortem {
	if len(match) > 0 {
		return typedFrom[IncidentPostmortem](e.Match(asMap(match[0])))
	}
	return typedFrom[IncidentPostmortem](e.Match())
}
...
func (e *IncidentPostmortemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IncidentPostmortemEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IncidentPostmortemEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IncidentPostmortemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IncidentPostmortemEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *IncidentPostmortemEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IncidentPostmortemRemoveMatch and returns an IncidentPostmortem. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *IncidentPostmortemEntity) RemoveTyped(reqmatch IncidentPostmortemRemoveMatch, ctrl map[string]any) (IncidentPostmortem, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return IncidentPostmortem{}, err
	}
	return typedFrom[IncidentPostmortem](res), nil
}



func (e *IncidentPostmortemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
