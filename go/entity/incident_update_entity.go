...
type IncidentUpdateEntity struct {
	name    string
...
func NewIncidentUpdateEntity(client *core.StatuspageSDK, entopts map[string]any) *IncidentUpdateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IncidentUpdateEntity) GetName() string { return e.name }
...
func (e *IncidentUpdateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IncidentUpdateEntity) Deleted() bool {
	return e.deleted
}


func (e *IncidentUpdateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIncidentUpdateEntity(e.client, opts)
}

func (e *IncidentUpdateEntity) Data(args ...any) any {
...
func (e *IncidentUpdateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IncidentUpdate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IncidentUpdateEntity) DataTyped(data ...IncidentUpdate) IncidentUpdate {
	if len(data) > 0 {
		return typedFrom[IncidentUpdate](e.Data(asMap(data[0])))
	}
	return typedFrom[IncidentUpdate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IncidentUpdate (all fields
// optional at the wire level).
func (e *IncidentUpdateEntity) MatchTyped(match ...IncidentUpdate) IncidentUpdate {
	if len(match) > 0 {
		return typedFrom[IncidentUpdate](e.Match(asMap(match[0])))
	}
	return typedFrom[IncidentUpdate](e.Match())
}
...
func (e *IncidentUpdateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IncidentUpdateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IncidentUpdateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IncidentUpdateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *IncidentUpdateEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IncidentUpdateUpdateData and returns an IncidentUpdate. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *IncidentUpdateEntity) UpdateTyped(reqdata IncidentUpdateUpdateData, ctrl map[string]any) (IncidentUpdate, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return IncidentUpdate{}, err
	}
	return typedFrom[IncidentUpdate](res), nil
}



func (e *IncidentUpdateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IncidentUpdateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
