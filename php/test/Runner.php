...
class StatuspageTestRunner
{
    ...
    {
        $live = self::getenv('STATUSPAGE_TEST_LIVE');
        $override = self::getenv('STATUSPAGE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('STATUSPAGE_TEST_EXPLAIN');
...
class_alias('StatuspageTestRunner', 'Runner');
class_alias('StatuspageHelpers', 'Helpers');
