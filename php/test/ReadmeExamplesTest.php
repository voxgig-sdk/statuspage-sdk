...
// Statuspage SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (StatuspageSDK::test)
...
{
    private const SDK_CLASS = 'StatuspageSDK';
    ...
    private const SDK_BASE = 'statuspage_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../statuspage_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
