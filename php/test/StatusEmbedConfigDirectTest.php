...
class StatusEmbedConfigDirectTest extends TestCase
{
    public function test_direct_load_status_embed_config(): void
    {
        $setup = status_embed_config_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-status_embed_config", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
