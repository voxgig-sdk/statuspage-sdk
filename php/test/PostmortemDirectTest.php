...
class PostmortemDirectTest extends TestCase
{
    public function test_direct_load_postmortem(): void
    {
        $setup = postmortem_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-postmortem", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
