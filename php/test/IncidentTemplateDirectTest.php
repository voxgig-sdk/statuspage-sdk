...
class IncidentTemplateDirectTest extends TestCase
{
    public function test_direct_list_incident_template(): void
    {
        $setup = incident_template_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-incident_template", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
