...
class ComponentGroupUptimeDirectTest extends TestCase
{
    public function test_direct_load_component_group_uptime(): void
    {
        $setup = component_group_uptime_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-component_group_uptime", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
