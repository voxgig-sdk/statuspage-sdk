...
// Statuspage SDK ComponentGroupUptime entity
...
class ComponentGroupUptimeEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "component_group_uptime";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ComponentGroupUptimeEntity($this->_client, $opts);
    }

    /**
     * @param ComponentGroupUptime|array $args ComponentGroupUptime data (assoc-array) to store.
     */
    ...
    /**
     * @return ComponentGroupUptime|array The current ComponentGroupUptime data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ComponentGroupUptime fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ComponentGroupUptime fields).
     */
    ...
    /**
     * Load a single ComponentGroupUptime.
     *
     * @param ComponentGroupUptimeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ComponentGroupUptimeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ComponentGroupUptime|array The loaded ComponentGroupUptime as an assoc-array at the
