...
class MetricEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MetricEntity($this->_client, $opts);
    }

    /**
     * @param Metric|array $args Metric data (assoc-array) to store.
     */
    ...
    /**
     * @return Metric|array The current Metric data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Metric fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Metric fields).
     */
     ...
     *
     * @param MetricLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MetricLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Metric|array The loaded Metric as an assoc-array at the
    ...
    /**
     * List Metric items matching the given filter.
     *
     * @param MetricListMatch|array|null $reqmatch Match filter (any subset
     *   of Metric fields) as an assoc-array; MetricListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Metric[]|array A list of Metric items as assoc-arrays at
     ...
     * Create a new Metric.
     *
     * @param MetricCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MetricCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Metric|array The created Metric as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
     ...
     *
     * @param MetricUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MetricUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Metric|array The updated Metric as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Metric matching the given criteria.
     *
     * @param MetricRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; MetricRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Metric|array The removed Metric as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
