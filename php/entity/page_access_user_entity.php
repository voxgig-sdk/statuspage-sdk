...
// Statuspage SDK PageAccessUser entity
...
class PageAccessUserEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PageAccessUserEntity($this->_client, $opts);
    }

    /**
     * @param PageAccessUser|array $args PageAccessUser data (assoc-array) to store.
     */
    ...
    /**
     * @return PageAccessUser|array The current PageAccessUser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PageAccessUser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PageAccessUser fields).
     */
    ...
    /**
     * Load a single PageAccessUser.
     *
     * @param PageAccessUserLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PageAccessUserLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PageAccessUser|array The loaded PageAccessUser as an assoc-array at the
    ...
    /**
     * List PageAccessUser items matching the given filter.
     *
     * @param PageAccessUserListMatch|array|null $reqmatch Match filter (any subset
     *   of PageAccessUser fields) as an assoc-array; PageAccessUserListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PageAccessUser[]|array A list of PageAccessUser items as assoc-arrays at
    ...
    /**
     * Create a new PageAccessUser.
     *
     * @param PageAccessUserCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PageAccessUserCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PageAccessUser|array The created PageAccessUser as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing PageAccessUser.
     *
     * @param PageAccessUserUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PageAccessUserUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PageAccessUser|array The updated PageAccessUser as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an PageAccessUser matching the given criteria.
     *
     * @param PageAccessUserRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PageAccessUserRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PageAccessUser|array The removed PageAccessUser as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
