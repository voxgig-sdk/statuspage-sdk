...
// Statuspage SDK Subscriber entity
...
class SubscriberEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SubscriberEntity($this->_client, $opts);
    }

    /**
     * @param Subscriber|array $args Subscriber data (assoc-array) to store.
     */
    ...
    /**
     * @return Subscriber|array The current Subscriber data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Subscriber fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Subscriber fields).
     */
     ...
     *
     * @param SubscriberLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SubscriberLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Subscriber|array The loaded Subscriber as an assoc-array at the
    ...
    /**
     * List Subscriber items matching the given filter.
     *
     * @param SubscriberListMatch|array|null $reqmatch Match filter (any subset
     *   of Subscriber fields) as an assoc-array; SubscriberListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Subscriber[]|array A list of Subscriber items as assoc-arrays at
     ...
     *
     * @param SubscriberCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SubscriberCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Subscriber|array The created Subscriber as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
     ...
     *
     * @param SubscriberUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SubscriberUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Subscriber|array The updated Subscriber as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Subscriber matching the given criteria.
     *
     * @param SubscriberRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; SubscriberRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Subscriber|array The removed Subscriber as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
