...
// Statuspage SDK IncidentUpdate entity
...
class IncidentUpdateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IncidentUpdateEntity($this->_client, $opts);
    }

    /**
     * @param IncidentUpdate|array $args IncidentUpdate data (assoc-array) to store.
     */
    ...
    /**
     * @return IncidentUpdate|array The current IncidentUpdate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IncidentUpdate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IncidentUpdate fields).
     */
    ...
    /**
     * Update an existing IncidentUpdate.
     *
     * @param IncidentUpdateUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IncidentUpdateUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IncidentUpdate|array The updated IncidentUpdate as an assoc-array at the
