...
class PageEntity
{
     ...
     * Load a single Page.
     *
     * @param PageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Page|array The loaded Page as an assoc-array at the
    ...
    /**
     * List Page items matching the given filter.
     *
     * @param PageListMatch|array|null $reqmatch Match filter (any subset
     *   of Page fields) as an assoc-array; PageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Page[]|array A list of Page items as assoc-arrays at
     ...
     *
     * @param PageUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PageUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Page|array The updated Page as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
