...
// Statuspage SDK Component entity
...
class ComponentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ComponentEntity($this->_client, $opts);
    }

    /**
     * @param Component|array $args Component data (assoc-array) to store.
     */
    ...
    /**
     * @return Component|array The current Component data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Component fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Component fields).
     */
     ...
     *
     * @param ComponentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ComponentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Component|array The loaded Component as an assoc-array at the
    ...
    /**
     * List Component items matching the given filter.
     *
     * @param ComponentListMatch|array|null $reqmatch Match filter (any subset
     *   of Component fields) as an assoc-array; ComponentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Component[]|array A list of Component items as assoc-arrays at
     ...
     *
     * @param ComponentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ComponentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Component|array The created Component as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
     ...
     *
     * @param ComponentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ComponentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Component|array The updated Component as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Component matching the given criteria.
     *
     * @param ComponentRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ComponentRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Component|array The removed Component as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
