...
// Statuspage SDK IncidentPostmortem entity
...
class IncidentPostmortemEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "incident_postmortem";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new IncidentPostmortemEntity($this->_client, $opts);
    }

    /**
     * @param IncidentPostmortem|array $args IncidentPostmortem data (assoc-array) to store.
     */
    ...
    /**
     * @return IncidentPostmortem|array The current IncidentPostmortem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IncidentPostmortem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IncidentPostmortem fields).
     */
    ...
    /**
     * Remove an IncidentPostmortem matching the given criteria.
     *
     * @param IncidentPostmortemRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; IncidentPostmortemRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IncidentPostmortem|array The removed IncidentPostmortem as an assoc-array at the
