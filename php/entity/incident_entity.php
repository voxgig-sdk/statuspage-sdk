...
// Statuspage SDK Incident entity
...
class IncidentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IncidentEntity($this->_client, $opts);
    }

    /**
     * @param Incident|array $args Incident data (assoc-array) to store.
     */
    ...
    /**
     * @return Incident|array The current Incident data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Incident fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Incident fields).
     */
     ...
     *
     * @param IncidentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IncidentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Incident|array The loaded Incident as an assoc-array at the
    ...
    /**
     * List Incident items matching the given filter.
     *
     * @param IncidentListMatch|array|null $reqmatch Match filter (any subset
     *   of Incident fields) as an assoc-array; IncidentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Incident[]|array A list of Incident items as assoc-arrays at
     ...
     *
     * @param IncidentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IncidentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Incident|array The created Incident as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
     ...
     *
     * @param IncidentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IncidentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Incident|array The updated Incident as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Incident matching the given criteria.
     *
     * @param IncidentRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; IncidentRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Incident|array The removed Incident as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
