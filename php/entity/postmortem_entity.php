...
// Statuspage SDK Postmortem entity
...
class PostmortemEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PostmortemEntity($this->_client, $opts);
    }

    /**
     * @param Postmortem|array $args Postmortem data (assoc-array) to store.
     */
    ...
    /**
     * @return Postmortem|array The current Postmortem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Postmortem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Postmortem fields).
     */
    ...
    /**
     * Load a single Postmortem.
     *
     * @param PostmortemLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PostmortemLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Postmortem|array The loaded Postmortem as an assoc-array at the
     ...
     *
     * @param PostmortemUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PostmortemUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Postmortem|array The updated Postmortem as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
