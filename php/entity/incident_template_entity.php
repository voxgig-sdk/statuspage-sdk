...
class IncidentTemplateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IncidentTemplateEntity($this->_client, $opts);
    }

    /**
     * @param IncidentTemplate|array $args IncidentTemplate data (assoc-array) to store.
     */
    ...
    /**
     * @return IncidentTemplate|array The current IncidentTemplate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IncidentTemplate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IncidentTemplate fields).
     */
     ...
     *
     * @param IncidentTemplateListMatch|array|null $reqmatch Match filter (any subset
     *   of IncidentTemplate fields) as an assoc-array; IncidentTemplateListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IncidentTemplate[]|array A list of IncidentTemplate items as assoc-arrays at
     ...
     *
     * @param IncidentTemplateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IncidentTemplateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IncidentTemplate|array The created IncidentTemplate as an assoc-array at the
