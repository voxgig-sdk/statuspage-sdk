...
// Statuspage SDK IncidentSubscriber entity
...
class IncidentSubscriberEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "incident_subscriber";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new IncidentSubscriberEntity($this->_client, $opts);
    }

    /**
     * @param IncidentSubscriber|array $args IncidentSubscriber data (assoc-array) to store.
     */
    ...
    /**
     * @return IncidentSubscriber|array The current IncidentSubscriber data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IncidentSubscriber fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IncidentSubscriber fields).
     */
    ...
    /**
     * Create a new IncidentSubscriber.
     *
     * @param IncidentSubscriberCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IncidentSubscriberCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IncidentSubscriber|array The created IncidentSubscriber as an assoc-array at the
