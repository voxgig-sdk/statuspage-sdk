...
// Statuspage SDK GroupComponent entity
...
class GroupComponentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GroupComponentEntity($this->_client, $opts);
    }

    /**
     * @param GroupComponent|array $args GroupComponent data (assoc-array) to store.
     */
    ...
    /**
     * @return GroupComponent|array The current GroupComponent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GroupComponent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GroupComponent fields).
     */
    ...
    /**
     * Load a single GroupComponent.
     *
     * @param GroupComponentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GroupComponentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupComponent|array The loaded GroupComponent as an assoc-array at the
    ...
    /**
     * List GroupComponent items matching the given filter.
     *
     * @param GroupComponentListMatch|array|null $reqmatch Match filter (any subset
     *   of GroupComponent fields) as an assoc-array; GroupComponentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupComponent[]|array A list of GroupComponent items as assoc-arrays at
     ...
     *
     * @param GroupComponentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GroupComponentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupComponent|array The created GroupComponent as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing GroupComponent.
     *
     * @param GroupComponentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GroupComponentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupComponent|array The updated GroupComponent as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an GroupComponent matching the given criteria.
     *
     * @param GroupComponentRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; GroupComponentRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GroupComponent|array The removed GroupComponent as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
