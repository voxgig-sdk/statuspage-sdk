...
// Statuspage SDK StatusEmbedConfig entity
...
class StatusEmbedConfigEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "status_embed_config";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new StatusEmbedConfigEntity($this->_client, $opts);
    }

    /**
     * @param StatusEmbedConfig|array $args StatusEmbedConfig data (assoc-array) to store.
     */
    ...
    /**
     * @return StatusEmbedConfig|array The current StatusEmbedConfig data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StatusEmbedConfig fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StatusEmbedConfig fields).
     */
    ...
    /**
     * Load a single StatusEmbedConfig.
     *
     * @param StatusEmbedConfigLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StatusEmbedConfigLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StatusEmbedConfig|array The loaded StatusEmbedConfig as an assoc-array at the
    ...
    /**
     * Update an existing StatusEmbedConfig.
     *
     * @param StatusEmbedConfigUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StatusEmbedConfigUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StatusEmbedConfig|array The updated StatusEmbedConfig as an assoc-array at the
     *   SDK boundary; throws StatuspageError on failure (item-5 convention).
     */
