...
// Statuspage SDK utility: graphql
//
...
class StatuspageGraphql
{
    ...
    // equivalent.
    public static function body(StatuspageContext $ctx): mixed
    {
    ...
    public static function errors(StatuspageContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
