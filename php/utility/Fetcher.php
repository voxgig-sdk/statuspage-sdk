...
// Statuspage SDK utility: fetcher
...
class StatuspageFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; StatuspageSDK/1.0)';
    ...
    public static function call(StatuspageContext $ctx, string $fullurl, array $fetchdef): array
    {
