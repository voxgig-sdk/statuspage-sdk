...
// Statuspage SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class StatuspageTransformResponse
{
    public static function call(StatuspageContext $ctx): mixed
    {
        ...
        $transform = StatuspageHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
