...
// Statuspage SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class StatuspageTestFeature extends StatuspageBaseFeature
{
    ...
    public function init(StatuspageContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (StatuspageContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = StatuspageParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (StatuspageContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(StatuspageContext $ctx, $op, $args): array
    {
