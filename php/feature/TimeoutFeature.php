...
// Statuspage SDK timeout feature
...
class StatuspageTimeoutFeature extends StatuspageBaseFeature
{
    ...
    private function _with_timeout(StatuspageContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(StatuspageContext $_ctx, float $ms): void
    {
        $client = $this->client;
