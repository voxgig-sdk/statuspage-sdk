...
class MetricEntity extends StatuspageEntityBase<Metric> {
  ...
  make(this: MetricEntity) {
    return new MetricEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: MetricLoadMatch, ctrl?: Control): Promise<MetricEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Metric> return stays clean under strict null checks.
  ...
  async list(this: any, reqmatch?: MetricListMatch, ctrl?: Control): Promise<MetricEntity[]> {
  ...
  async create(this: any, reqdata?: MetricCreateData, ctrl?: Control): Promise<MetricEntity> {
  ...
  async update(this: any, reqdata?: MetricUpdateData, ctrl?: Control): Promise<MetricEntity> {
  ...
  async remove(
    this: any, reqmatch?: MetricRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<MetricEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
