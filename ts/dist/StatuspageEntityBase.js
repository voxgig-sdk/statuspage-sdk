...
exports.StatuspageEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends StatuspageEntityBase<Advice>`.
class StatuspageEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.StatuspageEntityBase = StatuspageEntityBase;
//# sourceMappingURL=StatuspageEntityBase.js.map