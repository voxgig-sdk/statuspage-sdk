...
const TEST_SEED = { "entity": { "component": { "test01": { "id": "test01" } }, "component_group_uptime": { "test01": { "id": "test01" } }, "group_component": { "test01": { "id": "test01" } }, "incident": { "test01": { "id": "test01" } }, "incident_postmortem": { "test01": { "id": "test01" } }, "incident_subscriber": { "test01": { "id": "test01" } }, "incident_template": { "test01": { "id": "test01" } }, "incident_update": { "test01": { "id": "test01" } }, "metric": { "test01": { "id": "test01" } }, "metrics_provider": { "test01": { "id": "test01" } }, "page": { "test01": { "id": "test01" } }, "page_access_group": { "test01": { "id": "test01" } }, "page_access_user": { "test01": { "id": "test01" } }, "permission": { "test01": { "id": "test01" } }, "postmortem": { "test01": { "id": "test01" } }, "status_embed_config": { "test01": { "id": "test01" } }, "subscriber": { "test01": { "id": "test01" } }, "user": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+StatuspageSDK\b/.test(code) ||
        /\bStatuspageSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+StatuspageSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/StatuspageSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
