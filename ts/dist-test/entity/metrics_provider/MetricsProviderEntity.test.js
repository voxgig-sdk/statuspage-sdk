...
(0, node_test_1.describe)('MetricsProviderEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'metrics_provider.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/metrics_provider/MetricsProviderTestData.json');
    ...
    let idmap = transform(['metrics_provider01', 'metrics_provider02', 'metrics_provider03', 'page01', 'page02', 'page03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=MetricsProviderEntity.test.js.map