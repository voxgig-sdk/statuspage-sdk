...
(0, node_test_1.describe)('PageAccessUserDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-page_access_user', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-page_access_user', setup.live))
            return;
        ...
        if (setup.live) {
            const listResult = await client.direct({
                ...
                method: 'GET',
                params: {
                    id: setup.idmap['page_access_user01'],
                },
            });
    ...
    (0, node_test_1.test)('direct-list-page_access_user', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-page_access_user', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["page_access_user01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['STATUSPAGE_TEST_PAGE_ACCESS_USER_ENTID'];
...
//# sourceMappingURL=PageAccessUserDirect.test.js.map