...
(0, node_test_1.describe)('ComponentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'component.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['component01', 'component02', 'component03', 'page01', 'page02', 'page03', 'page01', 'page02', 'page03', 'page_access_group01', 'page_access_group02', 'page_access_group03', 'page01', 'page02', 'page03', 'page_access_user01', 'page_access_user02', 'page_access_user03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['STATUSPAGE_TEST_COMPONENT_ENTID'];
