...
(0, node_test_1.describe)('ComponentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-component', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-component', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-component', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-component', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["page_access_group01", "page01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
//# sourceMappingURL=ComponentDirect.test.js.map