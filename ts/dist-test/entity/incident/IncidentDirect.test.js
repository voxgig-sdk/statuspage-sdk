...
(0, node_test_1.describe)('IncidentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-incident', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-incident', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-incident', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-incident', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["page01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['STATUSPAGE_TEST_INCIDENT_ENTID'];
...
//# sourceMappingURL=IncidentDirect.test.js.map