...
(0, node_test_1.describe)('StatusEmbedConfigDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-status_embed_config', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-status_embed_config', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["page_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['STATUSPAGE_TEST_STATUS_EMBED_CONFIG_ENTID'];
...
//# sourceMappingURL=StatusEmbedConfigDirect.test.js.map