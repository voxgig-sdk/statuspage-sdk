...
(0, node_test_1.describe)('IncidentTemplateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-incident_template', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-incident_template', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['STATUSPAGE_TEST_INCIDENT_TEMPLATE_ENTID'];
...
//# sourceMappingURL=IncidentTemplateDirect.test.js.map