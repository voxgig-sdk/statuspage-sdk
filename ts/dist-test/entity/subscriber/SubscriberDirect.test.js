...
(0, node_test_1.describe)('SubscriberDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-subscriber', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-subscriber', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["incident01", "page01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-subscriber', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-subscriber', setup.live))
            return;
...
//# sourceMappingURL=SubscriberDirect.test.js.map