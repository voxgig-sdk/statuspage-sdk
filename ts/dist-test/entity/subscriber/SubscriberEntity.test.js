...
(0, node_test_1.describe)('SubscriberEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'subscriber.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/subscriber/SubscriberTestData.json');
    ...
    let idmap = transform(['subscriber01', 'subscriber02', 'subscriber03', 'page01', 'page02', 'page03', 'page01', 'page02', 'page03', 'incident01', 'incident02', 'incident03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SubscriberEntity.test.js.map