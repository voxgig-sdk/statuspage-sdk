...
function envOverride(m) {
    if ('TRUE' === process.env.STATUSPAGE_TEST_LIVE ||
        'TRUE' === process.env.STATUSPAGE_TEST_OVERRIDE) {
    ...
    m.STATUSPAGE_TEST_EXPLAIN = process.env.STATUSPAGE_TEST_EXPLAIN || m.STATUSPAGE_TEST_EXPLAIN;
    return m;
}
